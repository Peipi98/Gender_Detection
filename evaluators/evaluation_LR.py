...
def evaluate_LR(DTR, LTR, DTE, LTE, l, appendToTitle, PCA_Flag=True):
    ...
    scores = logistic_reg_score(DTR, LTR, DTE, l)
    ...
    if PCA_Flag is True:
        ...
        PCA_LR_scores = logistic_reg_score(DTR_PCA, LTR, DTE_PCA, l)
        ...
        PCA2_LR_scores = logistic_reg_score(DTR_PCA, LTR, DTE_PCA, l)
...
def evaluation_LR(DTR, LTR, DTE, LTE, L, appendToTitle, PCA_Flag=True):
